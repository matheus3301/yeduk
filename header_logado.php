        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item text-color" href="team.php">Alunos</a>
              <a class="dropdown-item text-color" href="pricing.php">Our Pricing</a>
              <a class="dropdown-item text-color" href="career.php">Our Career</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white text-capitalize" href="blog.php">blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white text-capitalize" href="contact.php">contact</a>
          </li>
        </ul>
